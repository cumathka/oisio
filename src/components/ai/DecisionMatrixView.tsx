  ...
  const tasks: DecisionTask[] = [
    {
      ...
      category: 'DO_FIRST',
      channel: 'SEO',
      summary: 'Prevents duplicate indexing in Swiss & EU Google SERPs with 10 min code fix.',
      confidence: 0.98,
    },
    {
      id: 'd-2',
      ...
      category: 'DO_FIRST',
      channel: 'SEA',
      summary: 'Instantly increases Google Ads Ad Strength to EXCELLENT and lowers CPC.',
      confidence: 0.95,
    },
    {
      id: 'd-3',
      ...
      category: 'PLAN',
      channel: 'SEO',
      summary: 'Migrate to /de/, /fr/, /it/ subpaths for full Swiss multilingual topical authority.',
      confidence: 0.92,
    },
    {
      id: 'd-4',
      ...
      category: 'PLAN',
      channel: 'CRO',
      summary: 'Directly impacts checkout conversion rate for Swiss corporate purchasers.',
      confidence: 0.89,
    },
    {
      id: 'd-5',
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800 pb-3">
        <div>
          <h2 className="text-base font-bold text-slate-100 flex items-center gap-2">
            ...
            <Badge variant="ai" size="sm">Eisenhower + ICE Model</Badge>
          </h2>
          <p className="text-xs text-slate-400 mt-0.5">
            Every marketing initiative is plotted mathematically by Impact (1-10) vs Effort (1-10) with verified truthfulness grounding.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {quadrants.map((quad) => {
          const quadTasks = filtered.filter((t) => t.category === quad.category);
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-bold text-slate-100">{quad.title}</h3>
                ...
                <div className="space-y-2">
                  {quadTasks.map((task) => (
                    ...
                    >
                      ...
                      <p className="text-[11px] text-slate-400 leading-snug">{task.summary}</p>

                      <div className="flex items-center justify-between pt-1 text-[10px] font-mono text-slate-500">
                        <span>Impact: {task.impact}/10 • Effort: {task.effort}/10</span>

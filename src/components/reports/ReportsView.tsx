      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800 pb-3">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Export comprehensive PDF & client-facing executive summaries with
            custom logo, color branding, and verified metrics.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card variant="surface" padding="md" className="space-y-3">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            Every Monday at 08:00 CET, an automated health audit and keyword
            shift report is dispatched to stakeholders.
          </p>
